...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  // ASCP_VERSION_APPEND_TIME_OF_DAY is set to true has the desired date.
  std::string ver = android::base::GetProperty("ro.ascp.build.version", "");
  ...
  std::vector<std::string> title_lines = {
    "Version: " + android::base::GetProperty("ro.ascp.build.version", "(unknown)") +
        " " + ver_date,
  };
